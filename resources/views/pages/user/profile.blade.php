                        ...
                        <div class="card border-0 shadow">
                            <div class="card-body d-flex justify-content-between align-items-center gap-3">
                                <div class="text-center">
                                    <img src="{{ $user->profile_image != null ? Storage::url($user->profile_image) : asset('assets/field-img.png') }}" class="rounded-circle object-fit-cover"
                                        alt="" width="100px" height="100px">
                                    <form action="{{ route('profile.updateImage') }}" method="POST" enctype="multipart/form-data" id="form-image">
                                        @csrf
                                        <label class="pe-pointer" id="label-profile" for="profile_image">Change Picture</label>
                                        <input type="file" class="d-none" name="profile_image" id="profile_image" accept="image/jpg,image/jpeg,image/png">
                                    </form>
                                </div>
